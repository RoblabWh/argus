...
class Map:
    ...
    def __init__(self, map_elements, width, height, blending, px_per_m, optimize, statusUpdate):
    ...
    def load_images(self):
        ...
        for map_element in self.map_elements:
            ...
            j = j + 1
            self.statusUpdate("Step 2/4: loading images: " + str(j) + "/" + str(len(self.map_elements)) )
    ...
    def add_images_to_map(self):
        ...
        try:
            for i, map_element in enumerate(self.map_elements):
                self.statusUpdate("Step 3/4: building map: " + str(i) + "/" + str(len(self.map_elements)))
                image = map_element.get_image().get_matrix()
